...
#library(tibble)
setwd("~/Papers/income/income_coding")# NOTE, your working directory is different. Adjust accordingly!!! 
dir()
...
table(h8$adopt2)
table(h8$adopt3)
# For Jessica's paper Table 2 begins
...
(variable = c("Any card", "No card", "Total", "No card/banked", "No card/unbanked", "Num respondents", "Percentage (%)", "Percentage (%)(w)", "Payments/month", "Spending/month ($)"))
length(variable)
# 0-10k column
